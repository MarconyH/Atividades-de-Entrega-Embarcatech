        ...
        if (params) {
            ...
            if (led_param == 1) {
                if (led_state) {
                    ...
                    //gpio_put(LED_GPIO, true); cyw43_gpio_set(&cyw43_state, LED_GPIO, true);  //não funciona com leds não integrados ao chip cyw43
                    ...
                    cyw43_gpio_set(&cyw43_state, LED_GPIO, false);  //não funciona com leds não integrados ao chip cyw43
